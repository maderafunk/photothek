...
<header><h1><svg class="site-logo" aria-hidden="true" viewBox="0 0 64 64" shape-rendering="crispEdges"><path fill-rule="evenodd" d="M0 0h64v64H0zM5 5v23h15V5zm0 28v26h15V33zM25 5v13h17V5zm0 18v22h17V23zm0 27v9h17V50zM47 5v32h12V5zm0 37v17h12V42z"/></svg><span>{title}</span></h1><div class="header-meta"><input class="theme-toggle" type="checkbox" id="theme-toggle" aria-label="Switch color theme"><label class="theme-switch" for="theme-toggle" title="Switch color theme"><span class="theme-track"><svg class="theme-knob" aria-hidden="true" viewBox="0 0 64 64" shape-rendering="crispEdges"><path fill-rule="evenodd" d="M0 0h64v64H0zM5 5v23h15V5zm0 28v26h15V33zM25 5v13h17V5zm0 18v22h17V23zm0 27v9h17V50zM47 5v32h12V5zm0 37v17h12V42z"/></svg></span></label><p class="edition">{len(cfg['sites']):02d} publications</p></div></header>
