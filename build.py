...
<div class="card-back"><span class="pictures{klass} back-pictures" aria-hidden="true">{"".join(imgs)}</span><label class="card-close" for="{control}" aria-label="Return to photographs"></label><a href="{href}">{name}<svg class="external-arrow" aria-hidden="true" viewBox="0 0 16 16"><path d="M3 13 13 3M6 3h7v7"/></svg></a></div>
</div></article>''')
...
<title>{title}</title><link rel="stylesheet" href="style.css?v=mirrored-back-1"></head>
