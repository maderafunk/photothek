...
<title>{title}</title><link rel="icon" href="favicon.svg?v=6" type="image/svg+xml"><link rel="icon" href="favicon.png?v=6" type="image/png" sizes="64x64"><link rel="shortcut icon" href="favicon.ico?v=6"><link rel="apple-touch-icon" href="apple-touch-icon.png?v=6"><link rel="stylesheet" href="style.css?v=theme-3"></head>
